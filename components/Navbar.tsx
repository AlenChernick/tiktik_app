    ...
    <div className='w-full flex justify-between items-center border-b-2 border-gray-200 py-2 px-4'>
      ...
      <div className='relative hidden md:block'>
        <form onSubmit={handleSearch} className='absolute md:static top-10 left-20 bg-white'>
          <input
            className='w-[300px] md:w-[350px] rounded-full md:top-0 bg-primary p-3 md:text-md font-medium border-2 border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300'
            type='text'
            value={searchValue}
      ...
      <div>
        {userProfile ? (
          <div className='flex gap-5 md:gap-10'>
            ...
            >
              <AiOutlineLogout color='#F51997' fontSize={33} className='mb-1' />
            </button>
          </div>
        ) : (
